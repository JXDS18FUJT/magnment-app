...
export default {
  ...
  methods: {
    reset() {
      ...
      this.checkboxGroup1 = []
      this.radio = "0"
      sessionStorage.setItem("filtterRadio","0")
    ...
    setSelectState(){
      //确定的时候的方法
      sessionStorage.setItem("filtterRadio",this.radio)
      sessionStorage.setItem("filtterCheckboxGroup0",this.checkboxGroup0.join(","))
      sessionStorage.setItem("filtterCheckboxGroup1",this.checkboxGroup1.join(","))
      switch (this.radio){
        case "0":
          this.$router.push({
            path:'/myDevice',
